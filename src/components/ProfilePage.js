                        ...
                        {currentUser ? (
                            <Card className="rounded shadow">
                                <Card.Body>
                                    ...
                                    <img src={currentUserMetadata.avatar_url} alt="User" className="rounded-circle img-fluid"
                                         style={{maxWidth: '150px'}}/>
                                </Card.Body>
                            </Card>
                        ) : (
                            <p>We're glad you're here! Unfortunately, you're not signed in at the moment. Sign in or
